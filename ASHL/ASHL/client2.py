...
class Trainer(nn.Module):
    ...
    def get_part(self):
        ...
        # time_ma[0] = iter_time 
        time_list = [dic['client'], sum(self.monitor)/len(self.monitor), sum(self.monitor1)*6/len(self.monitor1), sum(self.monitor2)*6/len(self.monitor2), sum(self.monitor3)/len(self.monitor3)]
    ...
    while(net.flag and i2<epoch2):
        ...
        for data, target in train_loader:
            ...
            if i % net.H == 0 and net.flag and not net.change_flag:
                ...
                if i1%6==0:
                    net.scheduler.step()
                time.sleep((time.time() - time3 -net.ps_time-net.compress_time)*5)
